...
class cube(object):
    ...
    def draw(self, surface, eyes=False):
        ...
        if eyes:
            center = dis // 2
            radius = 3
            #cmiddle = (i*dis+center-radius, j*dis*8)
            cmiddle2 = (i*dis + dis - radius*2, j*dis+8)
            #pygame.draw.circle(surface, (0,0,0), cmiddle, radius)
            pygame.draw.circle(surface, (0,0,0), cmiddle2, radius)
